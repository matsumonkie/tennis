...
var _user$project$Route$routeFromResult = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
...
var _user$project$Route$User = function (a) {
...
var _user$project$Route$matchers = _evancz$url_parser$UrlParser$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$Route$Users,
			_evancz$url_parser$UrlParser$s('users')),
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$Route$User,
			A2(
				_evancz$url_parser$UrlParser_ops['</>'],
				_evancz$url_parser$UrlParser$s('user'),
				_evancz$url_parser$UrlParser$int))
		]));
var _user$project$Route$hashParser = function (location) {
	return A3(
		_evancz$url_parser$UrlParser$parse,
		_elm_lang$core$Basics$identity,
		_user$project$Route$matchers,
		A2(_elm_lang$core$String$dropLeft, 1, location.hash));
};
var _user$project$Route$parser = _elm_lang$navigation$Navigation$makeParser(_user$project$Route$hashParser);

var _user$project$App_Model$init2 = function (route) {
	return {route: route};
};
...
var _user$project$App_Msg$Int = {ctor: 'Int'};
...
var _user$project$App_View$usersView = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _user$project$App_View$userView = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _user$project$App_View$homeView = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _user$project$App_View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'Home':
			return _user$project$App_View$homeView;
		case 'Users':
			return _user$project$App_View$usersView;
		case 'User':
			return _user$project$App_View$userView;
		default:
...
var _user$project$App_View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$App_View$page(model)
			]));
};

var _user$project$App_Main$init = function (result) {
	var currentRoute = _user$project$Route$routeFromResult(result);
	return {
		ctor: '_Tuple2',
		_0: _user$project$App_Model$init2(currentRoute),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$App_Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$App_Main$update = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$App_Main$urlUpdate = F2(
...
var _user$project$App_Main$main = {
	main: A2(
		_elm_lang$navigation$Navigation$program,
		_user$project$Route$parser,
		{init: _user$project$App_Main$init, view: _user$project$App_View$view, update: _user$project$App_Main$update, urlUpdate: _user$project$App_Main$urlUpdate, subscriptions: _user$project$App_Main$subscriptions})
};

var Elm = {};
Elm['App'] = Elm['App'] || {};
Elm['App']['Main'] = Elm['App']['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['App']['Main'], 'App.Main', typeof _user$project$App_Main$main === 'undefined' ? null : _user$project$App_Main$main);
